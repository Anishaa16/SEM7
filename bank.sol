...
contract SimpleBank {
    ...
    int clientCounter; 
    address payable public manager; // payable function to receives ether address is datatype it is 
    bytes20 public key; 
    ...
    constructor() {
        clientCounter = 0; // those client join contract assign their ID intially it set as 0
    }
